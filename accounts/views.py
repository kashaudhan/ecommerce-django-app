...
from accounts.forms import RegistrationForm, UserForm, UserProfileFrom
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # messages.success(request, 'Thank you for registering with us. We have sent you an email verification email. Kindly verify')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # get the common values in product_variation & ex_var_list
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        profile_form = UserProfileFrom(request.POST, request.FILES, instance=userprofile)
        ...
        profile_form = UserProfileFrom(instance=userprofile)
